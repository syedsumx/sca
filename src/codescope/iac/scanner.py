...
class IaCScanner:
    ...
    def scan_terraform(self, path: Path) -> list[IaCFinding]:
        ...
        findings.extend(self._tf0011_ec2_no_imdsv2(all_resources))
        findings.extend(self._tf0012_ec2_public_ip(all_resources))
        findings.extend(self._tf0013_ec2_no_monitoring(all_resources))
        findings.extend(self._tf0014_elb_no_ssl(all_resources))
        findings.extend(self._tf0015_elb_no_access_logs(all_resources))
        findings.extend(self._tf0016_alb_no_waf(all_resources))
        findings.extend(self._tf0017_cloudtrail_no_encryption(all_resources))
        findings.extend(self._tf0018_cloudtrail_no_validation(all_resources))
        findings.extend(self._tf0019_cloudwatch_no_encryption(all_resources))
        findings.extend(self._tf0020_kms_no_rotation(all_resources))
        findings.extend(self._tf0021_lambda_no_vpc(all_resources))
        findings.extend(self._tf0022_lambda_no_dlq(all_resources))
        findings.extend(self._tf0023_lambda_public(all_resources))
        findings.extend(self._tf0024_dynamodb_no_encryption(all_resources))
        findings.extend(self._tf0025_dynamodb_no_pitr(all_resources))
        findings.extend(self._tf0026_sns_no_encryption(all_resources))
        findings.extend(self._tf0027_sqs_no_encryption(all_resources))
        findings.extend(self._tf0028_sqs_no_dlq(all_resources))
        findings.extend(self._tf0029_elasticache_no_encryption(all_resources))
        findings.extend(self._tf0030_elasticache_no_auth(all_resources))
        findings.extend(self._tf0031_redshift_no_encryption(all_resources))
        findings.extend(self._tf0032_redshift_public(all_resources))
        findings.extend(self._tf0033_eks_no_encryption(all_resources))
        findings.extend(self._tf0034_eks_public_endpoint(all_resources))
        findings.extend(self._tf0035_eks_no_logging(all_resources))
        findings.extend(self._tf0036_ecr_no_scan(all_resources))
        findings.extend(self._tf0037_ecr_no_encryption(all_resources))
        findings.extend(self._tf0038_ecs_no_logging(all_resources))
        findings.extend(self._tf0039_ecs_privileged(all_resources))
        findings.extend(self._tf0040_codebuild_no_encryption(all_resources))
        findings.extend(self._tf0041_codebuild_privileged(all_resources))
        findings.extend(self._tf0042_secretsmanager_no_rotation(all_resources))
        findings.extend(self._tf0043_ssm_no_encryption(all_resources))
        findings.extend(self._tf0044_waf_no_logging(all_resources))
        findings.extend(self._tf0045_apigateway_no_logging(all_resources))
        findings.extend(self._tf0046_apigateway_no_auth(all_resources))
        findings.extend(self._tf0047_apigateway_no_waf(all_resources))
        findings.extend(self._tf0048_cloudfront_no_https(all_resources))
        findings.extend(self._tf0049_cloudfront_no_logging(all_resources))
        findings.extend(self._tf0050_cloudfront_no_waf(all_resources))
        findings.extend(self._tf0051_kinesis_no_encryption(all_resources))
        findings.extend(self._tf0052_kinesis_firehose_no_encryption(all_resources))
        findings.extend(self._tf0053_athena_no_encryption(all_resources))
        findings.extend(self._tf0054_glue_no_encryption(all_resources))
        findings.extend(self._tf0055_emr_no_encryption(all_resources))
        findings.extend(self._tf0056_sagemaker_no_encryption(all_resources))
        findings.extend(self._tf0057_sagemaker_no_vpc(all_resources))
        findings.extend(self._tf0058_elasticsearch_no_encryption(all_resources))
        findings.extend(self._tf0059_elasticsearch_public(all_resources))
        findings.extend(self._tf0060_msk_no_encryption(all_resources))
        findings.extend(self._tf0061_msk_no_logging(all_resources))
        findings.extend(self._tf0062_neptune_no_encryption(all_resources))
        findings.extend(self._tf0063_neptune_no_iam_auth(all_resources))
        findings.extend(self._tf0064_docdb_no_encryption(all_resources))
        findings.extend(self._tf0065_docdb_no_logging(all_resources))
        findings.extend(self._tf0066_efs_no_encryption(all_resources))
        findings.extend(self._tf0067_efs_no_backup(all_resources))
        findings.extend(self._tf0068_fsx_no_encryption(all_resources))
        findings.extend(self._tf0069_backup_vault_no_encryption(all_resources))
        findings.extend(self._tf0070_dax_no_encryption(all_resources))
        findings.extend(self._tf0071_memorydb_no_encryption(all_resources))
        findings.extend(self._tf0072_qldb_no_deletion_protection(all_resources))
        findings.extend(self._tf0073_timestream_no_encryption(all_resources))
        findings.extend(self._tf0074_keyspaces_no_encryption(all_resources))
        findings.extend(self._tf0075_route53_no_dnssec(all_resources))
        findings.extend(self._tf0076_acm_no_transparency_logging(all_resources))
        findings.extend(self._tf0077_config_no_encryption(all_resources))
        findings.extend(self._tf0078_guardduty_no_s3(all_resources))
        findings.extend(self._tf0079_macie_not_enabled(all_resources))
        findings.extend(self._tf0080_securityhub_not_enabled(all_resources))
        findings.extend(self._tf0081_inspector_not_enabled(all_resources))
        findings.extend(self._tf0082_iam_password_policy_weak(all_resources))
        findings.extend(self._tf0083_iam_user_no_mfa(all_resources))
        findings.extend(self._tf0084_iam_access_key_old(all_resources))
        findings.extend(self._tf0085_iam_group_no_policy(all_resources))
        findings.extend(self._tf0086_vpc_flow_logs_disabled(all_resources))
        findings.extend(self._tf0087_vpc_no_nacl(all_resources))
        findings.extend(self._tf0088_subnet_public_ip(all_resources))
        findings.extend(self._tf0089_nat_gateway_missing(all_resources))
        findings.extend(self._tf0090_transit_gateway_no_encryption(all_resources))
        findings.extend(self._tf0091_vpn_no_logs(all_resources))
        findings.extend(self._tf0092_network_firewall_no_logging(all_resources))
        findings.extend(self._tf0093_s3_no_versioning(all_resources))
        findings.extend(self._tf0094_s3_no_lifecycle(all_resources))
        findings.extend(self._tf0095_s3_no_replication(all_resources))
        findings.extend(self._tf0096_s3_no_object_lock(all_resources))
        findings.extend(self._tf0097_rds_no_backup(all_resources))
        findings.extend(self._tf0098_rds_no_multi_az(all_resources))
        findings.extend(self._tf0099_rds_no_deletion_protection(all_resources))
        findings.extend(self._tf0100_rds_no_iam_auth(all_resources))
        findings.extend(self._tf0101_rds_no_enhanced_monitoring(all_resources))
        findings.extend(self._tf0102_aurora_no_backtrack(all_resources))
        findings.extend(self._tf0103_aurora_no_global_db(all_resources))
        findings.extend(self._tf0104_elasticbeanstalk_no_https(all_resources))
        findings.extend(self._tf0105_apprunner_no_encryption(all_resources))
        findings.extend(self._tf0106_batch_no_logging(all_resources))
        findings.extend(self._tf0107_step_functions_no_logging(all_resources))
        findings.extend(self._tf0108_eventbridge_no_archive(all_resources))
        findings.extend(self._tf0109_xray_no_encryption(all_resources))
        findings.extend(self._tf0110_codecommit_no_encryption(all_resources))
